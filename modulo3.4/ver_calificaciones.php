...
if ($cod_estudiante) {
    $res_cal = pg_query_params($conexion,
        "SELECT materia, nota, periodo FROM calificaciones WHERE cod_estudiante = $1 ORDER BY periodo DESC, materia ASC",
        [$cod_estudiante]
    );
...
<body>
    <aside class="sidebar">
        ...
        <nav>
            <a href="ver_calificaciones.php" class="active">Mis Calificaciones</a>
        </nav>
        <div class="user">
